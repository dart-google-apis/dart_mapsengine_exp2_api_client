...
class AssetsResource_ {
  ...
  final AssetsPermissionsResource_ permissions;

  AssetsResource_(Client client) :
      _client = client,
      parents = new AssetsParentsResource_(client),
      permissions = new AssetsPermissionsResource_(client);
...
class AssetsPermissionsResource_ {

  final Client _client;

  AssetsPermissionsResource_(Client client) :
      _client = client;
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<PermissionsListResponse> list(core.String id, {core.Map optParams}) {
    var url = "assets/{id}/permissions";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
    ...
    response = _client.request(url, "GET", urlParams: urlParams, queryParams: queryParams);
    return response
      .then((data) => new PermissionsListResponse.fromJson(data));
  }
}
...
class LayersResource_ {
  ...
  final LayersPermissionsResource_ permissions;

  LayersResource_(Client client) :
      _client = client,
      parents = new LayersParentsResource_(client),
      permissions = new LayersPermissionsResource_(client);
   ...
   * [id] - The ID of the layer.
   *
   * [version] - Deprecated: The version parameter indicates which version of the layer should be returned. When version is set to published, the published version of the layer will be returned. Please use the layers.getPublished endpoint instead.
   *   Allowed values:
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<PublishedLayer> getPublished(core.String id, {core.String version, core.Map optParams}) {
...
class LayersPermissionsResource_ {

  final Client _client;

  LayersPermissionsResource_(Client client) :
      _client = client;

  /**
   * Remove permission entries from an already existing asset.
   *
   * [request] - PermissionsBatchDeleteRequest to send in this request
   *
   * [id] - The ID of the asset from which permissions will be removed.
   *
   * [optParams] - Additional query parameters
   */
  async.Future<PermissionsBatchDeleteResponse> batchDelete(PermissionsBatchDeleteRequest request, core.String id, {core.Map optParams}) {
    var url = "layers/{id}/permissions/batchDelete";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
    ...
    response = _client.request(url, "POST", body: request.toString(), urlParams: urlParams, queryParams: queryParams);
    return response
      .then((data) => new PermissionsBatchDeleteResponse.fromJson(data));
  }
...
An asset can hold up to 20 different permission entries. Each batchInsert request is atomic.
   *
   * [request] - PermissionsBatchUpdateRequest to send in this request
   *
   * [id] - The ID of the asset to which permissions will be added.
   *
   * [optParams] - Additional query parameters
   */
  async.Future<PermissionsBatchUpdateResponse> batchUpdate(PermissionsBatchUpdateRequest request, core.String id, {core.Map optParams}) {
    var url = "layers/{id}/permissions/batchUpdate";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
    ...
    response = _client.request(url, "POST", body: request.toString(), urlParams: urlParams, queryParams: queryParams);
    return response
      .then((data) => new PermissionsBatchUpdateResponse.fromJson(data));
  }
...
class MapsResource_ {
  ...
  final MapsPermissionsResource_ permissions;

  MapsResource_(Client client) :
      _client = client,
      permissions = new MapsPermissionsResource_(client);
   ...
   * [tags] - A comma separated list of tags. Returned assets will contain all the tags from the list.
   *
   * [version] - Deprecated: The version parameter indicates which version of the maps should be returned. When version is set to published this parameter will filter the result set to include only maps that are published. Please use the maps.listPublished endpoint instead.
   *   Allowed values:
   *     draft - The draft version.
   *     published - The published version.
   *
   * [optParams] - Additional query parameters
   */
  async.Future<MapsListResponse> list({core.String bbox, core.String createdAfter, core.String createdBefore, core.String creatorEmail, core.int maxResults, core.String modifiedAfter, core.String modifiedBefore, core.String pageToken, core.String processingStatus, core.String projectId, core.String role, core.String search, core.String tags, core.String version, core.Map optParams}) {
    var url = "maps";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class MapsPermissionsResource_ {

  final Client _client;

  MapsPermissionsResource_(Client client) :
      _client = client;
   ...
   */
  async.Future<PermissionsBatchDeleteResponse> batchDelete(PermissionsBatchDeleteRequest request, core.String id, {core.Map optParams}) {
    var url = "maps/{id}/permissions/batchDelete";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
An asset can hold up to 20 different permission entries. Each batchInsert request is atomic.
   ...
   */
  async.Future<PermissionsBatchUpdateResponse> batchUpdate(PermissionsBatchUpdateRequest request, core.String id, {core.Map optParams}) {
    var url = "maps/{id}/permissions/batchUpdate";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class PermissionIdsResource_ {

  final Client _client;

  PermissionIdsResource_(Client client) :
      _client = client;
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<PermissionsGetIdForEmailResponse> getIdForEmail(core.String email, {core.Map optParams}) {
    ...
    response = _client.request(url, "GET", urlParams: urlParams, queryParams: queryParams);
    return response
      .then((data) => new PermissionsGetIdForEmailResponse.fromJson(data));
  }
}
...
class ProjectsIconsResource_ {
  ...
  async.Future<Icon> create(Icon request, core.String projectId, {core.String content, core.String contentType, core.Map optParams}) {
    ...
    var uploadUrl = "/upload/mapsengine/exp2/projects/{projectId}/icons";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class RasterCollectionsResource_ {
  ...
  final RasterCollectionsPermissionsResource_ permissions;
  ...
  RasterCollectionsResource_(Client client) :
      ...
      permissions = new RasterCollectionsPermissionsResource_(client),
...
class RasterCollectionsPermissionsResource_ {

  final Client _client;

  RasterCollectionsPermissionsResource_(Client client) :
      _client = client;
   ...
   */
  async.Future<PermissionsBatchDeleteResponse> batchDelete(PermissionsBatchDeleteRequest request, core.String id, {core.Map optParams}) {
    var url = "rasterCollections/{id}/permissions/batchDelete";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
An asset can hold up to 20 different permission entries. Each batchInsert request is atomic.
   ...
   */
  async.Future<PermissionsBatchUpdateResponse> batchUpdate(PermissionsBatchUpdateRequest request, core.String id, {core.Map optParams}) {
    var url = "rasterCollections/{id}/permissions/batchUpdate";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
   ...
   */
  async.Future<PermissionsListResponse> list(core.String id, {core.Map optParams}) {
    var url = "rasterCollections/{id}/permissions";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class RastersFilesResource_ {
  ...
  async.Future<core.Map> insert(core.String id, core.String filename, {core.String content, core.String contentType, core.Map optParams}) {
    ...
    var uploadUrl = "/upload/mapsengine/exp2/rasters/{id}/files";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class RastersPermissionsResource_ {

  final Client _client;

  RastersPermissionsResource_(Client client) :
      _client = client;
   ...
   */
  async.Future<PermissionsListResponse> list(core.String id, {core.Map optParams}) {
    var url = "rasters/{id}/permissions";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class TablesResource_ {
  ...
  final TablesPermissionsResource_ permissions;
  ...
  TablesResource_(Client client) :
      ...
      permissions = new TablesPermissionsResource_(client);
...
Supported file types are listed in the Supported data formats and limits article of the Google Maps Engine help center.
  ...
  async.Future<core.Map> insert(core.String id, core.String filename, {core.String content, core.String contentType, core.Map optParams}) {
    ...
    var uploadUrl = "/upload/mapsengine/exp2/tables/{id}/files";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
class TablesPermissionsResource_ {

  final Client _client;

  TablesPermissionsResource_(Client client) :
      _client = client;
   ...
   */
  async.Future<PermissionsBatchDeleteResponse> batchDelete(PermissionsBatchDeleteRequest request, core.String id, {core.Map optParams}) {
    var url = "tables/{id}/permissions/batchDelete";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
...
An asset can hold up to 20 different permission entries. Each batchInsert request is atomic.
   ...
   */
  async.Future<PermissionsBatchUpdateResponse> batchUpdate(PermissionsBatchUpdateRequest request, core.String id, {core.Map optParams}) {
    var url = "tables/{id}/permissions/batchUpdate";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
