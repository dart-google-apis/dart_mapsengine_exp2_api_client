...
class Asset {
  ...
  Asset.fromJson(core.Map json) {
    ...
    if (json.containsKey("writersCanEditPermissions")) {
      writersCanEditPermissions = json["writersCanEditPermissions"];
    }
  }
  ...
  core.Map toJson() {
    ...
    if (writersCanEditPermissions != null) {
      output["writersCanEditPermissions"] = writersCanEditPermissions;
    }
...
class Permission {
  ...
  Permission.fromJson(core.Map json) {
    if (json.containsKey("discoverable")) {
  ...
  core.Map toJson() {
    ...
    if (discoverable != null) {
      output["discoverable"] = discoverable;
    }
...
class PermissionsBatchDeleteRequest {
  ...
  core.List<PermissionsBatchDeleteRequestPermissions> permissions;

  /** Create new PermissionsBatchDeleteRequest from JSON data */
  PermissionsBatchDeleteRequest.fromJson(core.Map json) {
    if (json.containsKey("permissions")) {
      permissions = json["permissions"].map((permissionsItem) => new PermissionsBatchDeleteRequestPermissions.fromJson(permissionsItem)).toList();
    }
  }

  /** Create JSON Object for PermissionsBatchDeleteRequest */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsBatchDeleteRequest */
  core.String toString() => JSON.encode(this.toJson());

}

class PermissionsBatchDeleteRequestPermissions {
  ...
  /** Create new PermissionsBatchDeleteRequestPermissions from JSON data */
  PermissionsBatchDeleteRequestPermissions.fromJson(core.Map json) {
    if (json.containsKey("emailAddress")) {
      emailAddress = json["emailAddress"];
    }
    if (json.containsKey("id")) {
  ...
  /** Create JSON Object for PermissionsBatchDeleteRequestPermissions */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsBatchDeleteRequestPermissions */
  core.String toString() => JSON.encode(this.toJson());
...
class PermissionsBatchDeleteResponse {
  ...
  /** Create new PermissionsBatchDeleteResponse from JSON data */
  PermissionsBatchDeleteResponse.fromJson(core.Map json) {
  }

  /** Create JSON Object for PermissionsBatchDeleteResponse */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsBatchDeleteResponse */
  core.String toString() => JSON.encode(this.toJson());
...
class PermissionsBatchUpdateRequest {
  ...
  /** Create new PermissionsBatchUpdateRequest from JSON data */
  PermissionsBatchUpdateRequest.fromJson(core.Map json) {
    if (json.containsKey("permissions")) {
      permissions = json["permissions"].map((permissionsItem) => new Permission.fromJson(permissionsItem)).toList();
    }
  }

  /** Create JSON Object for PermissionsBatchUpdateRequest */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsBatchUpdateRequest */
  core.String toString() => JSON.encode(this.toJson());
...
class PermissionsBatchUpdateResponse {
  ...
  /** Create new PermissionsBatchUpdateResponse from JSON data */
  PermissionsBatchUpdateResponse.fromJson(core.Map json) {
  }

  /** Create JSON Object for PermissionsBatchUpdateResponse */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsBatchUpdateResponse */
  core.String toString() => JSON.encode(this.toJson());

}

class PermissionsGetIdForEmailResponse {

  /** The permission ID. */
  core.String id;

  /** Create new PermissionsGetIdForEmailResponse from JSON data */
  PermissionsGetIdForEmailResponse.fromJson(core.Map json) {
    if (json.containsKey("id")) {
      id = json["id"];
    }
  }

  /** Create JSON Object for PermissionsGetIdForEmailResponse */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsGetIdForEmailResponse */
  core.String toString() => JSON.encode(this.toJson());
...
class PermissionsListResponse {
  ...
  /** Create new PermissionsListResponse from JSON data */
  PermissionsListResponse.fromJson(core.Map json) {
    if (json.containsKey("permissions")) {
      permissions = json["permissions"].map((permissionsItem) => new Permission.fromJson(permissionsItem)).toList();
    }
  }

  /** Create JSON Object for PermissionsListResponse */
  core.Map toJson() {
    var output = new core.Map();
  ...
  /** Return String representation of PermissionsListResponse */
  core.String toString() => JSON.encode(this.toJson());
